...
- StatsResetConfig.cs: Example of ModConfig for custom mod settings;
- StatsResetGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- StatsResetMain.cs: Main mod class, recieves mod management and general events;
- StatsResetTactical.cs: Example of ModTactical for modifying tactical level;
